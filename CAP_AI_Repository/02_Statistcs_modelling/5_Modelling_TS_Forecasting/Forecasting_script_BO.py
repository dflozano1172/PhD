...
#X_train = X__train[:1000,:,:]
#y_train = y__train[:1000,: ]
...
Forecast_fn.Validation_General_ts(ls, model, X_feat_scal_19_20, feature, feature_dict,'_LSTM0_', False) 
ls = random.sample(range(6000),250)
Forecast_fn.Validation_General_ts(ls, model, X_feat_scal_19_20, feature, feature_dict,'_LSTM1_', False)     
Forecast_fn.Validation_Samples_ts(ls, model, X_feat_scal_19_20, feature, feature_dict,'_LSTM_', False)    
...
# MODEL VALIDATION ----------------------------------    
ls = random.sample(range(6000),1250)
Forecast_fn.Validation_General_ts(ls, model2, X_feat_scal_19_20, feature, feature_dict,'_GRU0_', False) 
ls = random.sample(range(6000),250)
Forecast_fn.Validation_General_ts(ls, model2, X_feat_scal_19_20, feature, feature_dict,'_GRU1_', False)     
Forecast_fn.Validation_Samples_ts(ls, model2, X_feat_scal_19_20, feature, feature_dict,'_GRU_', False)    
...
nn_bo.maximize(init_points=3, n_iter=3)
...
ls = random.sample(range(6000),1250)
Forecast_fn.Validation_General_ts(ls, clf_model, X_feat_scal_19_20, feature, feature_dict,'_BOGRU0_', False) 
ls = random.sample(range(6000),250)
Forecast_fn.Validation_General_ts(ls, clf_model, X_feat_scal_19_20, feature, feature_dict,'_BOGRU1_', False)     
Forecast_fn.Validation_Samples_ts(ls, clf_model, X_feat_scal_19_20, feature, feature_dict,'_BOGRU_', False)    
...
ls = random.sample(range(6000),1250)
Forecast_fn.Validation_General_ts(ls, clf_model_LSTM, X_feat_scal_19_20, feature, feature_dict,'_BOLSTM0_', False) 
ls = random.sample(range(6000),250)
Forecast_fn.Validation_General_ts(ls, clf_model_LSTM, X_feat_scal_19_20, feature, feature_dict,'_BOLSTM1_', False)     
Forecast_fn.Validation_Samples_ts(ls, clf_model_LSTM, X_feat_scal_19_20, feature, feature_dict,'_BOLSTM_', False)    
