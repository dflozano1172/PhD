...
# Sampling Train Set
# =========================================
no_samples = 150 #Number of samples per class
...
samp_los_5 = random.sample(adms_ews5, 41)
...
samp_ews_5_t = random.sample(adms_ews5, 41) 
...
y_train = to_categorical(los_Y_train , num_classes = 8)
y_valid = to_categorical(los_Y_valid , num_classes = 8)
y_test  = to_categorical(los_Y_test , num_classes = 8)
...
nn = Sequential()
nn.add(layers.GRU(400, activation='tanh', return_sequences = False, input_shape=(48,32), 
...
history = nn.fit(X_train, y_train, 
                 validation_data=(X_valid, y_valid), epochs=250, batch_size=200, verbose=1)
