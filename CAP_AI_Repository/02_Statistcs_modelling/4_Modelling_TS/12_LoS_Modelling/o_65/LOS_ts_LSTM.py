...
nn = Sequential()
nn.add(layers.LSTM(400, activation='tanh', return_sequences = False, input_shape=(48,32), dropout=0.3,
...
history = nn.fit(X_train, y_train, 
                 validation_data=(X_valid, y_valid), epochs=300, batch_size=200, verbose=1)
