...
def nn_cl_bo2(cells1, cells2, cells3, activation1, activation2, activation3, 
    ...
    def nn_cl_fun():      
        nn = Sequential()
        nn.add(layers.GRU(140, activation=activation1, return_sequences = True, input_shape=(X_train.shape[1],X_train.shape[2])))
...
params_nn2 ={'cells1':(5,160)     , 'cells2':(1, 16)         , 'cells3':(5,16)  ,
             'activation1':(0, 9), 'activation2':(0, 9)     , 'activation3':(0, 9),
             'dropout1':(0,1)    , 'dropout_rate1':(0.1,0.3),
             'dropout2':(0,1)    , 'dropout_rate2':(0.1,0.3),
...
print("elapsed time the Bayesian Optimisation ", time.time()-t)
# ============================================================================
...
history = clf_model.fit(X_train, y_train, epochs=epochs, batch_size = batch_size, validation_split=0.3, verbose=0)
...
# plt.savefig(name +'_cm.png', transparent = True, bbox_inches = "tight")
# plt.show()
# # ============================================================================
